...
5. cordova run android --device or --emulator


This is child repository of https://github.com/mgechev/angular-seed, so please go through parent repository for easy to understand and better hands on.
